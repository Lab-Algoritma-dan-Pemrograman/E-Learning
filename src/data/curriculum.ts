      ...
      },
      {
        ...
        "lessons": [
          ...
          },
          {
            ...
            "testCases": [
              {
                "expectedOutput": "Panjang kata: 11\nHasil salinan: Programming\n",
                "description": "<span>Buat program yang mendeklarasikan string <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">kata = \"Programming\"</code>, lalu tampilkan panjangnya menggunakan <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">strlen()</code>, dan salin ke variabel lain menggunakan <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">strcpy()</code>.</span>"
              }
            ],
            "validationRules": [
              {
              ...
              {
                "message": "Salin dengan: strcpy(salinan, kata);",
                "pattern": "strcpy\\s*\\(\\s*salinan\\s*,\\s*kata\\s*\\)\\s*;",
                "shouldExist": true
              },
              {
                "message": "Gunakan format %s: printf(\"Hasil salinan: %s\\n\", salinan);",
          ...
          },
          {
            ...
            "explanation": "<div class=\"space-y-4\">\n      <p class=\"mb-4 text-zinc-700 leading-relaxed\">Header <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">&lt;math.h&gt;</code> menyediakan fungsi-fungsi <strong>matematika</strong> seperti akar kuadrat, pangkat, dan pembulatan. Saat dikompilasi dengan GCC, header ini sering memerlukan flag tambahan <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">-lm</code> (link math library). Modul menempatkan <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">&lt;stdlib.h&gt;</code> bersama <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">&lt;math.h&gt;</code> sebagai <strong>pustaka operasi matematik</strong>.</p>\n\n  <div class=\"my-4 overflow-x-auto\">\n    <table class=\"w-full border-collapse border border-zinc-200 text-xs\">\n            <thead>\n        <tr><th class=\"border border-zinc-200 px-3 py-1.5 bg-zinc-50 font-bold text-left\">Fungsi</th><th class=\"border border-zinc-200 px-3 py-1.5 bg-zinc-50 font-bold text-left\">Header</th><th class=\"border border-zinc-200 px-3 py-1.5 bg-zinc-50 font-bold text-left\">Kegunaan</th><th class=\"border border-zinc-200 px-3 py-1.5 bg-zinc-50 font-bold text-left\">Contoh</th></tr>\n      </thead>\n      <tbody>\n    <tr><td class=\"border border-zinc-200 px-3 py-1.5\"><code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">sqrt(bilangan)</code></td><td class=\"border border-zinc-200 px-3 py-1.5\"><code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">&lt;math.h&gt;</code></td><td class=\"border border-zinc-200 px-3 py-1.5\">Akar dari sebuah bilangan</td><td class=\"border border-zinc-200 px-3 py-1.5\"><code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">sqrt(64.0)</code></td></tr>\n    <tr><td class=\"border border-zinc-200 px-3 py-1.5\"><code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">pow(bilangan, pangkat)</code></td><td class=\"border border-zinc-200 px-3 py-1.5\"><code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">&lt;math.h&gt;</code></td><td class=\"border border-zinc-200 px-3 py-1.5\">Pemangkatan suatu bilangan</td><td class=\"border border-zinc-200 px-3 py-1.5\"><code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">pow(2.0, 10.0)</code></td></tr>\n    <tr><td class=\"border border-zinc-200 px-3 py-1.5\"><code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">sin(radian)</code></td><td class=\"border border-zinc-200 px-3 py-1.5\"><code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">&lt;math.h&gt;</code></td><td class=\"border border-zinc-200 px-3 py-1.5\">Nilai sinus sebuah sudut</td><td class=\"border border-zinc-200 px-3 py-1.5\"><code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">sin(0.0)</code></td></tr>\n    <tr><td class=\"border border-zinc-200 px-3 py-1.5\"><code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">cos(radian)</code></td><td class=\"border border-zinc-200 px-3 py-1.5\"><code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">&lt;math.h&gt;</code></td><td class=\"border border-zinc-200 px-3 py-1.5\">Nilai cosinus sebuah sudut</td><td class=\"border border-zinc-200 px-3 py-1.5\"><code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">cos(0.0)</code></td></tr>\n    <tr><td class=\"border border-zinc-200 px-3 py-1.5\"><code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">tan(radian)</code></td><td class=\"border border-zinc-200 px-3 py-1.5\"><code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">&lt;math.h&gt;</code></td><td class=\"border border-zinc-200 px-3 py-1.5\">Nilai tangen sebuah sudut</td><td class=\"border border-zinc-200 px-3 py-1.5\"><code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">tan(0.0)</code></td></tr>\n      </tbody>\n    </table>\n  </div>\n\n      <div class=\"my-4 not-prose\">\n        <div class=\"text-[10px] font-bold text-zinc-400 mb-1 uppercase tracking-wider\">Contoh Penggunaan Kode:</div>\n        <pre class=\"bg-zinc-950 text-zinc-100 p-4 rounded-xl font-mono text-xs overflow-x-auto border border-zinc-800\"><code>#include &lt;stdio.h&gt;\n#include &lt;math.h&gt;\n\nint main() {\n    double akar = sqrt(64.0);\n    double pangkat = pow(2.0, 10.0);\n\n    printf(&quot;Akar dari 64: %.0f\\n&quot;, akar);\n    printf(&quot;2 pangkat 10: %.0f\\n&quot;, pangkat);\n    return 0;\n}</code></pre>\n      </div>\n\n      <div class=\"my-4 not-prose\">\n        <div class=\"text-[10px] font-bold text-zinc-400 mb-1 uppercase tracking-wider\">Output Terminal:</div>\n        <div class=\"bg-zinc-950 text-emerald-400 p-4 rounded-2xl font-mono text-xs shadow-xl border border-zinc-800 max-w-xl\">\n          <div class=\"flex items-center gap-1.5 mb-2.5 border-b border-zinc-800 pb-2 text-zinc-500\">\n            <span class=\"w-2.5 h-2.5 rounded-full bg-[#ff5f56]\"></span>\n            <span class=\"w-2.5 h-2.5 rounded-full bg-[#ffbd2e]\"></span>\n            <span class=\"w-2.5 h-2.5 rounded-full bg-[#27c93f]\"></span>\n            <span class=\"ml-2 text-[10px] font-bold text-zinc-400\">terminal - workspace</span>\n          </div>\n          <div class=\"whitespace-pre-wrap font-semibold leading-relaxed\">\n            <span class=\"text-zinc-500\">$ gcc program.c -o program -lm &amp;&amp;./program</span>\n            <span class=\"block mt-1 text-zinc-100\">Akar dari 64: 8\n2 pangkat 10: 1024\n          </div>\n        </div>\n      </div>\n    </div>",
            "codeExample": "#include <stdio.h>\n#include <math.h>\n\nint main() {\n    double akar = sqrt(64.0);\n    double pangkat = pow(2.0, 10.0);\n\n    printf(\"Akar dari 64: %.0f\\n\", akar);\n    printf(\"2 pangkat 10: %.0f\\n\", pangkat);\n    return 0;\n}",
      ...
      },
      {
        ...
        "lessons": [
          ...
          },
          {
            ...
            "testCases": [
              {
                "expectedOutput": "Masukkan bilangan pertama: Masukkan bilangan kedua: Hasil bagi: 5\nSisa bagi: 3\n",
          ...
          },
          {
            ...
            "testCases": [
              {
                "expectedOutput": "Masukkan bilangan A: Masukkan bilangan B: A == B: 1\nA > B : 0\nA <= B: 1\n",
          ...
          },
          {
            ...
            "testCases": [
              {
                "expectedOutput": "Masukkan suhu tubuh: Status normal: 1\n",
    ...
    "modules": [
      ...
      },
      {
        ...
        "lessons": [
          ...
          {
            "id": "level-3-m6-l2",
            "title": "Menampilkan String dan Variabel (formatting string)",
            "explanation": "<div class=\"space-y-4\">\n      <ul class=\"list-disc pl-5 space-y-1 my-2 text-zinc-700\">\n  <li><strong>formatting string</strong> (formatted string literal), diperkenalkan di Python 3.6, adalah cara yang paling dianjurkan untuk <strong>menyisipkan nilai variabel ke dalam string</strong>. Caranya: tambahkan huruf <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">f</code> sebelum tanda petik, lalu tulis nama variabel di dalam kurung kurawal <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">{}</code>: <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">f\"Nama saya {nama}\"</code>.</li>\n</ul>\n<p class=\"mb-4 text-zinc-700 leading-relaxed\">formatting string juga mendukung <strong>ekspresi</strong> di dalam <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">{}</code> (tidak hanya variabel tunggal, tapi juga operasi matematika atau pemanggilan fungsi), dan mendukung <strong>format specifier</strong> mirip C menggunakan tanda titik dua, contoh: <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">f\"{nilai:.2f}\"</code> untuk 2 angka desimal, atau <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">f\"{angka:05d}\"</code> untuk padding angka dengan nol di depan hingga 5 digit. formatting string jauh lebih ringkas dibandingkan concatenation <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">+</code> atau metode <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">.format()</code> yang lebih lama.</p>\n\n      <div class=\"my-4 not-prose\">\n        <div class=\"text-[10px] font-bold text-zinc-400 mb-1 uppercase tracking-wider\">Contoh Penggunaan Kode:</div>\n        <pre class=\"bg-zinc-950 text-zinc-100 p-4 rounded-xl font-mono text-xs overflow-x-auto border border-zinc-800\"><code>nama = &quot;Maya&quot;\nusia = 21\nipk = 3.78912\n\nprint(f&quot;Nama saya {nama}, usia {usia} tahun.&quot;)\nprint(f&quot;IPK: {ipk:.2f}&quot;)          # 2 angka desimal\nprint(f&quot;Tahun depan: {usia + 1}&quot;)  # ekspresi di dalam {}\nprint(f&quot;Kode: {7:03d}&quot;)            # padding nol, lebar 3</code></pre>\n      </div>\n\n      <div class=\"my-4 not-prose\">\n        <div class=\"text-[10px] font-bold text-zinc-400 mb-1 uppercase tracking-wider\">Output Terminal:</div>\n        <div class=\"bg-zinc-950 text-emerald-400 p-4 rounded-2xl font-mono text-xs shadow-xl border border-zinc-800 max-w-xl\">\n          <div class=\"flex items-center gap-1.5 mb-2.5 border-b border-zinc-800 pb-2 text-zinc-500\">\n            <span class=\"w-2.5 h-2.5 rounded-full bg-[#ff5f56]\"></span>\n            <span class=\"w-2.5 h-2.5 rounded-full bg-[#ffbd2e]\"></span>\n            <span class=\"w-2.5 h-2.5 rounded-full bg-[#27c93f]\"></span>\n            <span class=\"ml-2 text-[10px] font-bold text-zinc-400\">terminal - workspace</span>\n          </div>\n          <div class=\"whitespace-pre-wrap font-semibold leading-relaxed\">\n            <span class=\"text-zinc-500\">$ python program.py</span>\n            <span class=\"block mt-1 text-zinc-100\">Nama saya Maya, usia 21 tahun.\nIPK: 3.79\nTahun depan: 22\nKode: 007</span>\n          </div>\n        </div>\n      </div>\n    </div>",
            ...
            "hint": "1. Lengkapi print() menggunakan formatting string (diawali huruf f\n   sebelum tanda petik).\n\n2. Di dalam formatting string, sisipkan variabel nama_produk\n   menggunakan tanda kurung kurawal {nama_produk}.\n\n3. Di dalam formatting string, sisipkan variabel harga dengan format\n   2 angka desimal menggunakan {harga:.2f}.",
            "quiz": {
              "question": "Bagaimana cara menyisipkan nilai variabel harga ke dalam string menggunakan formatting string?",
              "options": [
                "print(\"Harga: \" % harga)",
                "print(f\"Harga: {harga}\")",
                "print(\"Harga: \" . harga)",
            ...
            "testCases": [
              {
                ...
                "description": "<span>Buat variabel <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">nama_produk = \"Laptop\"</code> dan <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">harga = 7500000.5</code>. Gunakan formatting string untuk menampilkan nama produk dan harganya dengan 2 angka desimal.</span>"
              }
            ],
            "validationRules": [
              {
                "message": "Gunakan formatting string: print(f\"Produk: {nama_produk}, Harga: Rp{harga:.2f}\")",
    ...
    "modules": [
      {
        ...
        "lessons": [
          ...
          },
          {
            ...
            "hint": "1. Lengkapi isi blok if: simpan nilai \"Positif\" ke variabel\n   hasil, untuk kondisi angka lebih besar dari 0. Ingat indentasi\n   4 spasi.\n\n2. Lengkapi isi blok else: simpan nilai \"Negatif atau Nol\" ke\n   variabel hasil, untuk semua nilai angka lainnya.",
            "quiz": {
              "question": "Blok mana yang dijalankan jika kondisi pada if bernilai salah?",
              "options": [
                "blok if",
                "blok else",
                "keduanya dijalankan",
            ...
            "testCases": [
              {
                ...
                "description": "<span>Buat program yang membaca <code class=\"bg-zinc-100 px-1.5 py-0.5 rounded text-rose-700 font-mono text-xs\">int angka</code>, lalu gunakan <strong>if - else</strong> untuk menentukan apakah angka tersebut \"Positif\" atau \"Negatif atau Nol\", dan tampilkan hasilnya.</span>",
                "input": "-7"
              }
            ],
            "validationRules": [
              {
                "message": "Gunakan: if angka > 0:",
                "pattern": "if\\s+angka\\s*>\\s*0\\s*:",
                "shouldExist": true
              },
              {
                "message": "Sertakan blok else:",
                "pattern": "else\\s*:",
                "shouldExist": true
              },
              {
                "message": "Simpan hasil pada variabel: hasil",
                "pattern": "hasil\\s*=",
                "shouldExist": true
              }
            ]
